...
export default function Home() {
  ...
  useEffect(() => {
    async function loadData() {
      ...
      if (error) {
        console.error("Failed to load paper-concept relationships:", error);
      }

      setPapers(papers);
      setConcepts(concepts);

      setConnectedPapersCount(paperConcepts?.length ?? 0);
    }
  ...
  const relationshipCount = new Set(
    concepts.flatMap((concept) =>
      (concept.relations ?? []).map((relation) => {
        return [concept.id, relation.conceptId].sort().join("-");
      }),
    ),
  ).size;
          ...
          <div className="flex flex-col gap-6 sm:flex-row sm:items-end sm:justify-between">
            <div>
              ...
              <p className="mt-4 max-w-2xl text-base leading-7 text-(--muted)">
                A central overview of your papers, concepts, and the
          ...
          >
            <div className="flex items-start justify-between gap-4">
              <div>
                ...
                <h2 className="mt-2 text-xl font-semibold">Recent Papers</h2>
          ...
          >
            <div className="flex items-start justify-between gap-4">
              <div>
                ...
                <h2 className="mt-2 text-xl font-semibold">Recent Concepts</h2>
        ...
        <section className="mt-6">
          <div className="mb-4">
            ...
            <p className="mt-1 max-w-2xl text-sm leading-6 text-(--muted)">
              Explore how your concepts connect to each other and how they form
          ...
          <ResearchAnalytics concepts={concepts} papers={papers} />

          {/* Graph statistics */}
          <div className="mt-4 grid gap-3 sm:grid-cols-3">
            <GraphStat value={concepts.length} label="Concepts" />
            ...
            <GraphStat value={connectedPapersCount} label="Paper connections" />
          </div>
        </section>
        ...
        <section className="mt-6">
          ...
          <div className="mt-4 grid gap-4 sm:grid-cols-2">
            ...
            >
              ...
              <h3 className="mt-4 text-base font-semibold">Add a Paper</h3>
            ...
            >
              ...
              <h3 className="mt-4 text-base font-semibold">Create a Concept</h3>
