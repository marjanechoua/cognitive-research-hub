  ...
  return (
      ...
      <div className="mx-auto max-w-6xl px-6 py-10">
        ...
        <header className="flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
          <div>
            ...
            <h1 className="mt-2 text-3xl font-semibold">Papers</h1>
    ...
    "
        ...
        <div className="mt-10 grid gap-4 md:grid-cols-3">
          ...
          <StatCard
            label="Reading"
            value={papers.filter((paper) => paper.status === "reading").length}
          />

          <StatCard
            label="Analyzed"
            value={papers.filter((paper) => paper.status === "analyzed").length}
          />
        </div>
  ...
  return (
    ...
    >
      <div className="flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
        ...
        <span className="shrink-0 text-sm text-(--muted)">View →</span>
      </div>
    </Link>
  );
}
...
function NoResults({
  ...
  if (!hasPapers) {
    return (
      <div className="rounded-2xl border border-dashed border-(--border) p-12 text-center">
        <h2 className="text-lg font-medium">Your research library is empty</h2>
  ...
  return (
    <div className="rounded-2xl border border-dashed border-(--border) p-12 text-center">
      <h2 className="text-lg font-medium">No papers found</h2>
